...
void transposeM8(int16_t *input, int16_t *output, uint32_t N)
{
    ...
    int16_t *out2 = out1 + VEC_16CAP;
    int16_t *out3 = out2 + VEC_16CAP;
    int16_t *out4 = out3 + VEC_16CAP;
    int16_t *out5 = out4 + VEC_16CAP;
    int16_t *out6 = out5 + VEC_16CAP;
    int16_t *out7 = out6 + VEC_16CAP;
...
void transposeN8(int16_t *input, int16_t *output, uint32_t M)
{
    ...
    int16_t *in1, *in2, *in3, *in4, *in5, *in6, *in7;
